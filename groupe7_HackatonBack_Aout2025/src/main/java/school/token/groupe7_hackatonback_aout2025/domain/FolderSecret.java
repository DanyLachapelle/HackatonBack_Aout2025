...
@Entity
@Table(name = "folder_secret")
public class FolderSecret {
    ...
    private FolderSecret parentFolder;
    ...
    public FolderSecret(String name, String path, User user, String encryptedPassword, String salt) {
        this();
        this.name = name;
        this.path = path;
        this.user = user;
    ...
    public FolderSecret getParentFolder() {
        return parentFolder;
    }
    
    public void setParentFolder(FolderSecret parentFolder) {
