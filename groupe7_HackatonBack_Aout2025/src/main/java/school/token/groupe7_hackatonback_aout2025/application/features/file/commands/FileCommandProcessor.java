...
public class FileCommandProcessor {
    ...
    public FileCommandProcessor(ICommandHandler<CreateFileCommand, CreateFileOutput> createFileHandler, ICommandHandler<UploadFileCommand, UploadFileOutput> uploadFileHandler, ICommandHandler<UpdateFileContentCommand, UpdateFileContentOutput> updateFileContentHandler) {
